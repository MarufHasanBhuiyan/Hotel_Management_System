...
<br><br>
                     <h3>All Archived Search-Matched Data</h3>
    ...
    <div class="table">
        <table class="table table-bordered">
            ...
            include 'connection.php';
            $keyword = $_GET['search'];
            $sql= "SELECT * FROM archive WHERE fullname LIKE '%$keyword%' OR location LIKE '%$keyword%' OR roomno LIKE '%$keyword%' OR mobile LIKE '%$keyword%'";
