...
<head>
    ...
    <title>Guest's Service Requests</title>
         ...
         <div >
            <form action="userservicerequestsearch.php" method="get" class="search-bar">
                        <input type="search" class=" search-input form-control"
                            placeholder="Search By Name,Room No,Service Name...." name="search" id="search" >
...
<br><br>
               <h3>All Service Requests Data</h3>
    <div class="table">
    ...
    <tr>
        ...
        <td><?= $row['details'] ?></td>
        <td>
            <a href="completedrequest.php?id=<?=$row['id']?>" class="done-btn" data-id="<?=$row['id']?>">
