...
<body>
    ...
    <div class="nav-bar">
        <div class="logo">
         ...
         <div >
            <form action="bookingsearch.php" method="get" class="search-bar">
    ...
    <div class="menu">
        <a href="admindashboardbooking.php" class="btn-admindashboard" ><b>Booking✔️</b></a>
    ...
    <div class="menu1">
        ...
        <div class="total">
            ...
            <?php
            $sql = "SELECT COUNT(id) as total_bookings FROM booking";
...
<br><br>
    ...
    <tr>
        ...
        <td>
            <a href="updatebooking.php?id=<?=$row['id']?>" ><i class="fa fa-edit" title="update"></i></a>
            &nbsp;&nbsp;
            <a href="deletebooking.php?id=<?=$row['id']?>" ><i class="fa fa-trash" title="delete"></i></a>
            &nbsp;&nbsp;
            <a href="bookingtocheckin.php?id=<?=$row['id']?>" ><i class="fa fa-sign-in-alt " title="checkin"></i>
</a>
        </td>
    </tr>
<?php } ?>
